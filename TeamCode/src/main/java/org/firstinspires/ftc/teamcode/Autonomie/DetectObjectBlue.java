...
public class DetectObjectBlue extends OpenCvPipeline {
    Mat mat = new Mat();
    ...
    static final Rect zona_mijloc = new Rect(
            ...
            new Point(120 + offset, 220));

    static final Rect zona_dreapta = new Rect(
            new Point(120 + offset * 2, 135),
            new Point(180 + offset * 2, 220));


    static double procentObiectPeZona = 0.05;
    ...
    public Mat processFrame(Mat input) {
        ...
        Scalar lowHSV = new Scalar(16.5, 45, 45);
        Scalar highHSV = new Scalar(36.5, 255, 255);
