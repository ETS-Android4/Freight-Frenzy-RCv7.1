...
public class RedAuto1 extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        if (tip_autonomie == 2){
            motor_slider.setTargetPosition(1390);
            motor_slider.setPower(1);
            while(motor_slider.isBusy());
            motor_slider.setPower(0);
        ...
        .lineToLinearHeading(new Pose2d(last_x - 12, last_y + 54.5, Math.abs(185)))
        .build());
        ...
        .lineToLinearHeading(new Pose2d(-10.5, 0, Math.toRadians(270)))
                .build());
